...
const AuthSignIn = (props: any) => {
      ...
      return (
            ...
            >
                  ...
                  >
                        ...
                        >
                              <div style={{ margin: "20px" }}>
                                    <Link href="/" ><ArrowBackOutlined /></Link>
                                    <Box sx={{
                                          display: "flex",
                                          justifyContent: "center",
                                          alignItems: "center",
                  ...
                  <Snackbar open={open} autoHideDuration={5000} onClose={handleClose} message={errorMessage} anchorOrigin={{ vertical: "top", horizontal: "center" }} >
